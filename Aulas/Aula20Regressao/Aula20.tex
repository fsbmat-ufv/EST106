...
\definecolor{graygreen}{RGB}{60, 90, 100}
\usecolortheme[RGB={50, 149, 168}]{structure}
% Definir cor personalizada acinzentada com verde

% Aplicar essa cor à estrutura e aos elementos-chave
\setbeamercolor{structure}{fg=graygreen}
\setbeamercolor{frametitle}{bg=graygreen, fg=white}
\setbeamercolor{title}{fg=graygreen}
\setbeamercolor{item}{fg=graygreen}
\setbeamercolor{block title}{bg=graygreen, fg=white}
\setbeamercolor{block body}{bg=gray!5, fg=black}
%\usecolortheme{dove} % ou troque por "teal", "darkgray", ou RGB personalizado
\setbeamertemplate{navigation symbols}{}
\setbeamertemplate{footline}[frame number]
\setbeamertemplate{headline}{}
% Definindo as cores de cada parte do rodapé
\setbeamercolor{author in head/foot}{fg=black, bg=LightCyan}
\setbeamercolor{title in head/foot}{fg=white, bg=Lightblue}
\setbeamercolor{site in head/foot}{fg=white, bg=Gray}
