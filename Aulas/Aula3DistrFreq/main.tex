...
%\begin{block}{}
%\justifying
%Na página da disciplina há um material sobre %distribuição de frequências com um exemplo. Para %acessá-lo, \href{https://rawgit.com/maf105/maf105.githu%b.io/master/Materiais/Dist_freq.pdf}{clique aqui}!
%\end{block}
%\end{frame}
